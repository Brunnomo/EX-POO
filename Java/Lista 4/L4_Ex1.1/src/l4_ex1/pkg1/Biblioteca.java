...
public class Biblioteca {
    ...
    public Livro[] listarFilosofia(){ //Retorna uma lista com todos os livros de filosofia
    ...
    public int contarCiencia(){ //Retorna a quantidade de livros de Ciência na biblioteca
        int qtd = 0;
        Estante e;
        for(int i=0;i<estantes.size();i++){
            e=estantes.get(i);
